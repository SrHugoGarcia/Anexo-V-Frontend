...
export default function Side() {
  ...
  return (
    <div className="mt-16 h-full fixed md:inset-y-0 md:flex md:w-48 md:h-screen md:flex-col bg-[#009640]">
                ...
                >
                  <Disclosure.Button
                    ...
                    className={classNames(
                      ...
                      "group w-full flex items-center md:pl-2 md:pr-1 py-2 text-left text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-white"
                    )}
                  >
                    <item.icon
                      ...
                      aria-hidden="true"
                    />
                    <span className="flex-1 md:block hidden">{item.name}</span>
                  </Disclosure.Button>
                </Tooltip>
              </Link>
            </Disclosure>
