...
export default function AnexoVtable() {
          ...
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
               Aqui puedes descargar cualquier anexo que gustes.
              </p>
            </div>
          </div>
                          ...
                          <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-0 flex justify-between text-center">
                            <>
                             {componente.url ? 
                              ...
                              <a href={componente.url} className="text-white text-base font-semibold hover:text-slate-900 text-md border bg-green-600 px-2 rounded-md py-2">
                                Descargar Anexo
                              </a>
                            </td>: <td className="whitespace-nowrap py-4 px-3 text-sm text-center">
                              <a  className="text-white text-base font-semibold hover:text-slate-900 text-md border bg-red-700 px-2 rounded-md py-2">
                                No se ha generado
                              </a>
                            </td>}
                            </>
