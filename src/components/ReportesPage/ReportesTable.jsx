          ...
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
               Aqui puedes descargar cualquier informe que gustes.
              </p>
            </div>
          </div>
                          ...
                          <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-0 flex justify-between text-center">
                            <>
                             {componente.informeURL ? 
                              ...
                              <a href={componente.informeURL} className="text-white text-base font-semibold hover:text-slate-900 text-md border bg-green-600 px-2 rounded-md py-2">
                                Descargar Informe
                              </a>
